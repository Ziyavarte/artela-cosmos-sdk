...
// Compaction mocks base method.
func (m *MockDB) Compaction() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Compaction")
}

// Compaction indicates an expected call of Compaction.
func (mr *MockDBMockRecorder) Compaction() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Compaction", reflect.TypeOf((*MockDB)(nil).Compaction))
}
...
func (m *MockDB) Iterator(start, end []byte) (cosmos_db.Iterator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Iterator", start, end)
	ret0, _ := ret[0].(cosmos_db.Iterator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDB) NewBatch() cosmos_db.Batch {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewBatch")
	ret0, _ := ret[0].(cosmos_db.Batch)
	return ret0
}
...
func (m *MockDB) NewBatchWithSize(arg0 int) cosmos_db.Batch {
	m.ctrl.T.Helper()
...
func (m *MockDB) ReverseIterator(start, end []byte) (cosmos_db.Iterator, error) {
	m.ctrl.T.Helper()
